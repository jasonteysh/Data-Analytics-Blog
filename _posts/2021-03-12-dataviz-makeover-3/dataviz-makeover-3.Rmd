...
| 3  | Year of Event | Create additional filters to allow toggling of year. In fact, to better visualize changes, animation may be a good option. |
...
Next, we confirm that the animation is on by clicking on the Format tab on the Toolbar, selecting "Animations..." then check that it is on "On" 
