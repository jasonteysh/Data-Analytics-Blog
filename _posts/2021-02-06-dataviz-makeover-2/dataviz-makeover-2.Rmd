...
#knitr::include_graphics("C:/ISSS608 Visualization Analytics/DataViz Makeover/Data Analytics Blog/_posts/2021-02-06-dataviz-makeover-2/Media/Original.PNG")
...
| 2   | Order of Country for 100% Bar Chart  | The main drawback of the visualization is the lack of meaningful sort (which is presented in an alphabetical order). In this case, viewers will need to visually seek out the country with the longest blue bar in order to make meaningful deduction (assuming only the blue bars are of interest to the viz-maker - which leads to the next issue)|
| 3   | Lack of Proper Definition for Responses | While the titular question asked which country is more pro-vaccination, there is no clear indication of which color segment constitutes the "pro-vaccine" population (i.e. should we count the orange bar? What about the red bar?). This is related to Issue 6 below|
| 4   | Missing Survey Question | This is another major flaw of the visualization - there is no way of knowing what was the question that respondents strongly agree or disagree to even if we know what each color is referring to. |
| 5   | Ambiguous Unit of Measure | "% of Total Record" does not sufficiently explain what the base of the "%" is, and what constitutes the "Total Record"  |
| 6   | Incomplete Information on Colors Presented | The legend does not give any description for the values 2 (orange), 3 (red), and 4 (light blue). It does not clearly reflect that the segments are ordinal (i.e. in order of any significance) and hence muddy the interpretation of the viz. (see Issue *X* in Aesthetic segment below) |
| 7   |  Meaningless Headers in Legend | Similar to Issue 4 above, "Vac 1" does not explain what question the response was for and is as meaningless as putting any random symbol |
...
| 3   | Inconsistent Order | While both the left- and right-hand viz are sending similar message, the fact that they are sorted differently makes them aesthethically irritable (and no less confusing - as covered in S/n 2 in Clarity section above) |
...
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Divergent\Step1.PNG" style="width:60%; display:block; margin:0 auto;">
...
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Uncertainty\Step7.PNG" style="width:80%; display:block; margin:0 auto;">

Upper and Lower Bound based on Parameter input
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Uncertainty\Step7a.PNG" style="width:40%; display:block; margin:0 auto;"> <img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Uncertainty\Step7b.PNG" style="width:40%; display:block; margin:0 auto;">

And one final variable to display as marginal value for the upper and lower confidence interval
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Uncertainty\Step15d.PNG" style="width:40%; display:block; margin:0 auto;"> 
...
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Uncertainty\Step23.PNG" style="width:60%; display:block; margin:0 auto;"> 

**Step 4.4 - Filters** 

Before we put everything together, let's create one more filter - Age Group
...
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Uncertainty\Step24.PNG"> 
...
<img src="C:\ISSS608 Visualization Analytics\DataViz Makeover\Data Analytics Blog\_posts\2021-02-06-dataviz-makeover-2\Media\Tableau - Dashboard\Step0.PNG">
